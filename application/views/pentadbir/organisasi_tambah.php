            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Tambah Organisasi<small>Ruangan bertanda asterik (*) wajib diisi.</small></h2>
                        </div>
                        <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'inpHirarki';
                                            $value = (empty(set_value($FormName))) ? '0' : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group form-float">
                                            ...
                                            $checked = (empty(set_checkbox($FormName))) ? '' : set_checkbox($FormName, 'Ya');
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
