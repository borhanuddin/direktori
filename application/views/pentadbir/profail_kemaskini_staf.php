            ...
            <?php if (isset($_SESSION['errSQL'])) { ?>
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <div class="alert alert-danger" role="alert"><strong><?php echo $_SESSION['errSQL']['code'] ?></strong> <?php echo $_SESSION['errSQL']['message'] ?></div>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Kemaskini Maklumat Staf<small>Ruangan bertanda asterik (*) wajib diisi.</small></h2>
                        </div>
                        <div class="body">
                            
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="alert alert-info" role="alert"><strong>PERINGATAN!</strong> Mengemaskini Nama Penuh, E-Mel atau Status memerlukan anda Log Masuk semula.</div>
                                </div>
                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-3">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'inpGelaran';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_gelaran : set_value($FormName);
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'inpNama';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_nama : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-2">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'inpMyKad';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_mykad : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'inpJawatan';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_jawatan : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'inpGred';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_gred : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-2">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'inpTaraf';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_taraf : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'inpEmel';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_emel : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'slcStatus';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_status : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <?php
                                            $FormName = 'txtCatatan';
                                            $value = (empty(set_value($FormName))) ? $profail->staf_catatan : set_value($FormName);
                                            $focused = (empty($value) && !is_numeric($value)) ? '' : ' focused';
                                            $error = (empty(form_error($FormName))) ? '' : ' error';
                                            ?>
                                            <div class="form-line<?php echo $focused . $error; ?>">
